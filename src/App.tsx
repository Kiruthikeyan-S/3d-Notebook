          ...
          <div className="relative z-10 flex flex-col items-center gap-6 max-w-md w-full bg-white/95 backdrop-blur-md border border-slate-200/80 rounded-3xl p-8 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleAccountLogin} className="w-full flex flex-col gap-4">
              ...
              <button
                ...
                className="w-full py-2.5 px-4 rounded-xl bg-white hover:bg-slate-50 text-slate-800 font-semibold text-xs border border-slate-200 shadow-sm transition-all flex items-center justify-center gap-2.5 active:scale-[0.99]"
              >
              ...
              <div className="relative flex items-center justify-center my-1">
                ...
                <span className="absolute px-3 bg-white text-[10px] uppercase tracking-wider font-mono text-slate-400">
                  Or use Email
                </span>
              </div>
